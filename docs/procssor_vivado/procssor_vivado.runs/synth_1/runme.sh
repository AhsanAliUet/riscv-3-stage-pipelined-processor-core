...
HD_PWD='H:/Semester 7/CA/Lab/Lab11/fpga/docs/procssor_vivado/procssor_vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log riscv_pipelined_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source riscv_pipelined_top.tcl
