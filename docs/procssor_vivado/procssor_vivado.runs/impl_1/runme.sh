...
HD_PWD='H:/Semester 7/CA/Lab/Lab11/fpga/docs/procssor_vivado/procssor_vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log riscv_pipelined_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source riscv_pipelined_top.tcl -notrace
